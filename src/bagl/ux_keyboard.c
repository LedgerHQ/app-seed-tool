...
const bagl_element_t screen_common_keyboard_elements[] = {
    ...
    // typed word
    {{BAGL_RECTANGLE, 0x00, 18, 18, 110 - 18, 14, 0, 4, BAGL_FILL, 0xFFFFFF,
      0x000000, 0, 0},
     NULL},
    {{BAGL_LABELINE, 0x10, 128 / 2 - 12 / 2 - 40, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x11, 128 / 2 - 12 / 2 - 30, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x12, 128 / 2 - 12 / 2 - 20, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x13, 128 / 2 - 12 / 2 - 10, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x14, 128 / 2 - 12 / 2, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x15, 128 / 2 - 12 / 2 + 10, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x16, 128 / 2 - 12 / 2 + 20, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x17, 128 / 2 - 12 / 2 + 30, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x18, 128 / 2 - 12 / 2 + 40, 28, 12, 12, 0, 0, 0, 0x000000,
      0xFFFFFF, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    ...
    // current item
    {{BAGL_RECTANGLE, 0x22, 57, 12 - 10, 14, 14, 0, 4, BAGL_FILL, 0xFFFFFF,
      0x000000, 0, 0},
     NULL},
    {{BAGL_LABELINE, 0x02, 58, 12, 12, 13, 0, 0, BAGL_FILL, 0x000000, 0xFFFFFF,
      BAGL_FONT_OPEN_SANS_REGULAR_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    // {{BAGL_LABELINE                       , 0x02,  57,  12,  14,  13, 0, 4,
    // BAGL_FILL, 0x000000,
    // 0xFFFFFF,
    ...
    // left/rights icons
    {{BAGL_ICON, 0x00, 3, 12, 4, 7, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0},
...
const bagl_element_t screen_common_keyboard_elements[] = {
    ...
    // erase
    {{BAGL_RECTANGLE, 0x00, 0, 0, 128, 64, 0, 0, BAGL_FILL, 0x000000, 0xFFFFFF,
      0, 0},
     NULL},

    // title
    {{BAGL_LABELINE, 0x04, 0, 20, 128, 32 - 5, 0, 0, 0, 0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_REGULAR_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},

    // typed word
    {{BAGL_LABELINE, 0x10, 128 / 2 - 12 / 2 - 40, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x11, 128 / 2 - 12 / 2 - 30, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x12, 128 / 2 - 12 / 2 - 20, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x13, 128 / 2 - 12 / 2 - 10, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x14, 128 / 2 - 12 / 2, 48 + 5, 14, 14, 0, 0, 0, 0xFFFFFF,
      0x000000, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER,
      0},
     NULL},
    {{BAGL_LABELINE, 0x15, 128 / 2 - 12 / 2 + 10, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x16, 128 / 2 - 12 / 2 + 20, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x17, 128 / 2 - 12 / 2 + 30, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LABELINE, 0x18, 128 / 2 - 12 / 2 + 40, 48 + 5, 14, 14, 0, 0, 0,
      0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},

    // slider elements
    {{BAGL_LABELINE, 0x01, 29, 36, 14, 13, 0, 0, BAGL_FILL, 0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_REGULAR_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LINE, 0x06, 48, 32, 4, 1, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0}, NULL},
    {{BAGL_RECTANGLE, 0x00, 57, 36 - 10, 14, 14, 0, 4, BAGL_FILL, 0xFFFFFF,
      0x000000, 0, 0},
     NULL},
    {{BAGL_LABELINE, 0x02, 58, 36, 12, 13, 0, 0, BAGL_FILL, 0x000000, 0xFFFFFF,
      BAGL_FONT_OPEN_SANS_EXTRABOLD_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
    {{BAGL_LINE, 0x07, 76, 32, 4, 1, 0, 0, 0, 0xFFFFFF, 0x000000, 0, 0}, NULL},
    {{BAGL_LABELINE, 0x03, 85, 36, 14, 13, 0, 0, BAGL_FILL, 0xFFFFFF, 0x000000,
      BAGL_FONT_OPEN_SANS_REGULAR_11px | BAGL_FONT_ALIGNMENT_CENTER, 0},
     NULL},
...
#ifdef TARGET_NANOS
        case 0x22:
            e = G_bolos_ux_context.keyboard_callback(
                KEYBOARD_RENDER_ITEM, G_bolos_ux_context.hslider3_current);
...
unsigned int screen_common_keyboard_button(unsigned int button_mask,
    ...
    switch (button_mask) {
        case BUTTON_EVT_RELEASED | BUTTON_LEFT |
            ...
            // validate the item, and if accepted, then redisplay current
            // screen, else don't draw anything
            if (G_bolos_ux_context.keyboard_callback(
                    KEYBOARD_ITEM_VALIDATED,
...
void screen_common_keyboard_init(unsigned int stack_slot,
    ...
    G_ux.stack[stack_slot].element_arrays[0].element_array =
        screen_common_keyboard_elements;
    ...
    G_ux.stack[stack_slot].screen_before_element_display_callback =
        screen_common_keyboard_before_element_display_callback;  // used for
                                                                 // each screen
                                                                 // of the
                                                                 // validate pin
                                                                 // flow
