...
def all_eink_sskr_256bit(backend, device):
    ...
    backend.wait_for_text_on_screen("toe priority custom gauge jacket theme arrest bargain gloom wide ill fit eagle prepare capable fish limb cigar reform other priority speak rough imitate", 1)
    review.exit()
