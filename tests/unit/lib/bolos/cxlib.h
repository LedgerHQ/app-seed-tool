...
cx_err_t cx_bn_alloc_init(cx_bn_t *bn_x, size_t size, const uint8_t *bytes,
                              size_t nbytes);
cx_err_t cx_bn_nbytes(const cx_bn_t bn_x, size_t *nbytes);
cx_err_t cx_bn_export(const cx_bn_t bn_x, uint8_t *bytes, size_t nbytes);
cx_err_t cx_bn_copy(cx_bn_t bn_a, const cx_bn_t bn_b);
cx_err_t cx_bn_set_u32(cx_bn_t bn_x, uint32_t n);
cx_err_t cx_bn_get_u32(const cx_bn_t bn_x, uint32_t *n);
cx_err_t cx_bn_cmp_u32(const cx_bn_t bn_a, uint32_t b, int *diff);
...
cx_err_t cx_bn_tst_bit(const cx_bn_t bn_x, uint32_t pos, bool *set);
cx_err_t cx_bn_set_bit(cx_bn_t bn_x, uint32_t pos);
cx_err_t cx_bn_clr_bit(cx_bn_t bn_x, uint32_t pos);
cx_err_t cx_bn_shr(cx_bn_t r, uint32_t n);
cx_err_t cx_bn_shl(cx_bn_t r, uint32_t n);
cx_err_t cx_bn_cnt_bits(cx_bn_t bn_x, uint32_t *nbits);
...
cx_err_t cx_bn_mod_add(cx_bn_t r, const cx_bn_t a, const cx_bn_t b,
                           const cx_bn_t m);
cx_err_t cx_bn_mod_sub(cx_bn_t r, const cx_bn_t a, const cx_bn_t b,
                           const cx_bn_t m);
cx_err_t cx_bn_mod_mul(cx_bn_t r, const cx_bn_t a, const cx_bn_t b,
                           const cx_bn_t m);
cx_err_t cx_bn_reduce(cx_bn_t r, const cx_bn_t d, const cx_bn_t n);
cx_err_t cx_bn_mod_sqrt(cx_bn_t bn_r, const cx_bn_t bn_a,
                            const cx_bn_t bn_n, uint32_t sign);
cx_err_t cx_bn_is_odd(const cx_bn_t bn_a, bool *odd);
cx_err_t cx_bn_mod_invert_nprime(cx_bn_t bn_r, const cx_bn_t bn_a,
                                     const cx_bn_t bn_n);
cx_err_t cx_bn_mod_u32_invert(cx_bn_t bn_r, const uint32_t e,
                                  const cx_bn_t bn_n);
cx_err_t cx_bn_mod_pow(cx_bn_t bn_r, const cx_bn_t bn_a, const uint8_t *e,
                           uint32_t len_e, const cx_bn_t bn_n);
cx_err_t cx_bn_mod_pow_bn(cx_bn_t bn_r, const cx_bn_t bn_a,
                              const cx_bn_t bn_e, const cx_bn_t bn_n);
cx_err_t cx_bn_mod_pow2(cx_bn_t bn_r, const cx_bn_t bn_a, const uint8_t *e,
                            uint32_t len_e, const cx_bn_t bn_n);
cx_err_t cx_bn_is_prime(const cx_bn_t bn_x, bool *prime);
cx_err_t cx_bn_next_prime(const cx_bn_t bn_x);
...
cx_err_t cx_ecdomain_parameter(cx_curve_t curve, cx_curve_dom_param_t id,
                                   uint8_t *p, uint32_t p_len);
cx_err_t cx_ecdomain_parameter_bn(cx_curve_t curve, cx_curve_dom_param_t id,
                                      cx_bn_t p);
cx_err_t cx_ecdomain_generator(cx_curve_t curve, uint8_t *Gx, uint8_t *Gy,
                                   size_t len);
...
cx_err_t cx_ecpoint_init(cx_ecpoint_t *ec_P, const uint8_t *x, size_t x_len,
                             const uint8_t *y, size_t y_len);
cx_err_t cx_ecpoint_init_bn(cx_ecpoint_t *ec_P, const cx_bn_t bn_x,
                                const cx_bn_t bn_y);
cx_err_t cx_ecpoint_export_bn(const cx_ecpoint_t *ec_P, cx_bn_t *bn_x,
                                  cx_bn_t *bn_y);
cx_err_t cx_ecpoint_export(const cx_ecpoint_t *P, uint8_t *x, size_t x_len,
                               uint8_t *y, size_t y_len);
cx_err_t cx_ecpoint_compress(const cx_ecpoint_t *P, uint8_t *xy_compressed,
                                 size_t xy_compressed_len, uint32_t *sign);
cx_err_t cx_ecpoint_decompress(cx_ecpoint_t *ec_P,
                                   const uint8_t *xy_compressed,
                                   size_t xy_compressed_len, uint32_t sign);
cx_err_t cx_ecpoint_add(cx_ecpoint_t *ec_R, const cx_ecpoint_t *ec_P,
                            const cx_ecpoint_t *ec_Q);
cx_err_t cx_ecpoint_neg(cx_ecpoint_t *ec_P);
cx_err_t cx_ecpoint_cmp(const cx_ecpoint_t *ec_P, const cx_ecpoint_t *ec_Q,
                            bool *is_equal);
cx_err_t cx_ecpoint_scalarmul(cx_ecpoint_t *ec_P, const uint8_t *k,
                                  size_t k_len);
cx_err_t cx_ecpoint_scalarmul_bn(cx_ecpoint_t *ec_P, const cx_bn_t bn_k);
cx_err_t cx_ecpoint_rnd_scalarmul(cx_ecpoint_t *ec_P, const uint8_t *k,
                                      size_t k_len);
cx_err_t cx_ecpoint_rnd_scalarmul_bn(cx_ecpoint_t *ec_P,
                                         const cx_bn_t bn_k);
cx_err_t cx_ecpoint_rnd_fixed_scalarmul(cx_ecpoint_t *ec_P,
                                            const uint8_t *k, size_t k_len);
cx_err_t cx_ecpoint_double_scalarmul(cx_ecpoint_t *ec_R, cx_ecpoint_t *ec_P,
                                         cx_ecpoint_t *ec_Q, const uint8_t *k,
                                         size_t k_len, const uint8_t *r,
                                         size_t r_len);
cx_err_t cx_ecpoint_double_scalarmul_bn(cx_ecpoint_t *ec_R,
                                            cx_ecpoint_t *ec_P,
                                            cx_ecpoint_t *ec_Q,
                                            const cx_bn_t bn_k,
                                            const cx_bn_t bn_r);
cx_err_t cx_ecpoint_is_on_curve(const cx_ecpoint_t *ec_P,
                                    bool *is_on_curve);
cx_err_t cx_ecpoint_is_at_infinity(const cx_ecpoint_t *ec_P,
                                       bool *is_infinite);
cx_err_t cx_ecpoint_x25519(const cx_bn_t bn_u, const uint8_t *k,
                               size_t k_len);
cx_err_t cx_ecpoint_x448(const cx_bn_t bn_u, const uint8_t *k,
                             size_t k_len);
cx_err_t cx_bls12381_key_gen(uint8_t mode, const uint8_t *secret,
                                 size_t secret_len, const uint8_t *salt,
                                 size_t salt_len, uint8_t *key_info,
                                 size_t key_info_len,
                                 cx_ecfp_384_private_key_t *private_key,
                                 uint8_t *public_key, size_t public_key_len);
cx_err_t cx_hash_to_field(const uint8_t *msg, size_t msg_len,
...
cx_err_t cx_bls12381_aggregate(const uint8_t *in, size_t in_len, bool first,
