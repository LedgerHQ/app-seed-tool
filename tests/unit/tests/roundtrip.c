...
*
*     tuna next keep hard data acid able able acid able
...
*     hope peck bulb iced cyan runs
*
*     tuna next keep hard data acid able able acid acid
...
*     wand oboe film many keys guru
*
*     tuna next keep hard data acid able able acid also
...
uint8_t sskr_hex[]        = {0xD9, 0x9D, 0x75, 0x58, 0x25, 0x01, 0x00, 0x00,
                             ...
                             0x5F, 0xAA, 0xD9, 0x9D, 0x75, 0x58, 0x25, 0x01,
...
static void test_bip39_to_sskr(void **state) {
    ...
    sskr_words_buffer[sskr_words_buffer_len] = '\0';
