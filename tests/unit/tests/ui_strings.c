...
static const struct {
    ...
    ENTRY(UI_STR_NBGL_BIP85_APP_PIN),
    ...
    ENTRY(UI_STR_NBGL_BIP85_PIN_HEADER),
    ENTRY(UI_STR_NBGL_BIP85_PIN_LENGTH_TITLE),
    ENTRY(UI_STR_NBGL_BIP85_PIN_DIGITS_4),
    ENTRY(UI_STR_NBGL_BIP85_PIN_DIGITS_6),
    ENTRY(UI_STR_NBGL_BIP85_PIN_DIGITS_8),
    ENTRY(UI_STR_NBGL_BIP85_RESULT_LABEL_SEPARATOR),
    ...
    ENTRY(UI_STR_NBGL_BIP85_REVIEW_APP_LANGUAGE),
    ...
    ENTRY(UI_STR_NBGL_BIP85_REVIEW_LENGTH_DIGITS),
    ENTRY(UI_STR_NBGL_BIP85_REVEAL_WARN_BIP39),
    ENTRY(UI_STR_NBGL_BIP85_REVEAL_WARN_PWD),
    ENTRY(UI_STR_NBGL_BIP85_REVEAL_WARN_PIN),
    ENTRY(UI_STR_NBGL_BIP85_PIN_DERIVE_ERROR),
