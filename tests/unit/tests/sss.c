...
static void test_sss_recover(void **state) {
    ...
    const uint8_t share1_2[] = {0x0C, 0xAA, 0x8B, 0x78, 0x31, 0x30, 0xEE, 0xB3,
                                0xA5, 0x0F, 0xF0, 0x22, 0xFA, 0x90, 0x79, 0x24,
                                0x6D, 0x99, 0x83, 0xA2, 0x02, 0xDA, 0xF5, 0xBA,
                                0xE1, 0x10, 0x51, 0xC2, 0xA2, 0x1A, 0x4B, 0x0E};

    const uint8_t share1_3[] = {0x48, 0x00, 0x1A, 0xBA, 0xF2, 0xFE, 0x1B, 0x5C,
    ...
    const uint8_t share2_2[] = {0xB4, 0x8E, 0x81, 0x9F, 0xBB, 0x8A, 0x1C, 0xC3,
                                0xCF, 0xFB, 0x10, 0xBB, 0xC7, 0xB7, 0x96, 0xBC,
                                0xBD, 0xB3, 0x4F, 0x1E, 0x21, 0xCE, 0x04, 0x94,
                                0x48, 0x1E, 0x79, 0x8C, 0x0D, 0x7E, 0xEA, 0xA2};

    const uint8_t share2_3[] = {0x69, 0x16, 0xCF, 0x5B, 0xEB, 0x40, 0x89, 0x9D,
